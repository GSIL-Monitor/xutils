...
public class HttpResult_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.ckjava.xutils.http.HttpResult"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HttpResult_ESTest_scaffolding.class.getClassLoader() ,
      "com.ckjava.xutils.ExceptionUtils",
      "com.ckjava.xutils.http.HttpResult"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.Throwable", false, HttpResult_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HttpResult_ESTest_scaffolding.class.getClassLoader()); 
