...
public class TestHttpClientUtils extends HttpClientUtils {
	...
	@Test
	public void addParamValue() {
		String url = "http://test.pha.com/api/maniphest.search?";
		try {
			String url1 = addParamValue(url, "名字", "张三");
			System.out.println(url1);
			String url2 = addParamValue(url, "name", "张三");
			System.out.println(url2);
			String url3 = addParamValue(url, "名字", "Alice");
			System.out.println(url3);
			String url4 = addParamValue(url, "name", "Alice");
