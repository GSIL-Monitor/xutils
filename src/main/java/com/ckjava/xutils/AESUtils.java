...
public class AESUtils extends StringUtils {
	...
	/*
	 * public static void main(String[] args) { try { byte[] data = "您好, hello"
	 * .getBytes(CHARSET.UTF8); String hexString = byte2HexString(data);
	 * 
	 * System.out.println("data hexString=" + hexString); byte[] dataBytes =
	 * hexString2Byte(hexString); System.out.println("final String=" + new
	 * String(dataBytes, CHARSET.UTF8));
	 * 
	 * // 大写F的值为 70 System.out.println('F'+10); System.out.println('a' - 'A');
